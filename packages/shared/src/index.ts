// Stable domain types for Genesis Science.
...
/** One recorded write of an artifact — a line in `.genesisscience/provenance.jsonl`.
...
export interface ProvenanceEnv {
  ...
  platform: string;
  /** Genesis Science app version that recorded it. */
  app: string;
...
// bundled `genesisscience.mplstyle` which carries the same hexes). Validated with
