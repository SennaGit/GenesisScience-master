...
import { seriesColor, CHART_PALETTE_LIGHT, CHART_PALETTE_DARK } from "@aether-synth/shared";

// The palette is the single source of truth shared with index.css --series-*
// and runtime/.../genesisscience.mplstyle. Lock the hexes so those three stay in sync.
