...
import {
  ...
  type SkillInfo,
  type ToolCallStatus,
} from "@aether-synth/sdk";
import type { ArtifactBlock, RuntimeStatus, ThreadBlock } from "@aether-synth/shared";
import {
...
const URL_KEY = "aetherSynth.opencodeUrl";
const HIDDEN_KEY = "aetherSynth.hiddenExamples";
...
async function performTurn(
  ...
  try {
    ...
    if (!id) {
      ...
      // own fresh dated folder (~/Documents/GenesisScience/<date-time>) first,
