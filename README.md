...
[![Genesis Science — An open AI workbench for scientists](./docs/assets/banner.webp)](https://github.com/aether-synth/GenesisScience)
...
- **Multi-domain** — starting with reproducible computational science, expanding to materials, chemistry, biology,
...
| **Artifact provenance** | Every agent write appends a version record to `.genesisscience/provenance.jsonl`; a History panel shows each version's code, model, and originating conversation. |
...
- `research-explorer`, `literature-survey`, `experiment-suite`, `paper-writer`,
  `mindmap-render`, `integrity-auditor`, `aether-synth-agent` — the
  [aether-synth-skills](https://github.com/aether-synth/aether-synth-skills) pack.
...
| `runtime/skills/external/` | The bundled `aether-synth-skills` pack (fetched by script) |
...
[aether-synth-skills](https://github.com/aether-synth/aether-synth-skills) pack. Thanks to
