...
Part of: Genesis Science Desktop v0.1 (see `docs/PRD.md`, `docs/TECHNICAL_DESIGN.md`)
...
Content is illustrative (adapted to Genesis Science, not copied verbatim from Claude Science).
