# Genesis Science Desktop — Product Requirements
...
**Genesis Science Desktop** is an open-source AI research workbench with macOS /
...
Versus ordinary AI paper tools, Genesis Science is different because it is:
...
5. Multi-domain — expanding from biology to materials, chemistry, medicine, and engineering,
...
2. **scientific AI developers** — integrating scientific skills, MCP, and
...
2. **Self-authored Aether Synth skills** — planned: `literature-review`, `reproducible-analysis`,
...
**Genesis Science Desktop is an open-source research agent workbench with macOS and
