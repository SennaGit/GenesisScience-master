...
The Genesis Science **OpenCode profile** — the config + skills the app ships and applies
...
skills/            # Aether Synth scientific skills (Markdown, agentskills.io format)
...
- Skills are NOT shipped from here: the bundled aether-synth-skills pack lives in
