...
Brand name: **Genesis Science** — "An open AI workbench for scientists. Your research
partner for rigorous science." (Bundle identifier stays `com.aethersynth.genesisscience` and
internal package names use the `@aether-synth/*` scope; app data uses `com.aethersynth.genesisscience`.)
